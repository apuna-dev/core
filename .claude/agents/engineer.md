---
name: Engineer
description: Use when implementing Next.js 16 App Router routes and server logic, TypeScript types, React/Tailwind integration, Cloudflare Workers config (@opennextjs/cloudflare), build/deploy, or any backend/infrastructure concern for the Apuna website.
model: sonnet
tools:
  - Read
  - Write
